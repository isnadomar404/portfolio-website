...
const INFO = [
  {
    icon: Mail,
    label: "Email",
    value: "isnadbinomar@gmail.com",
    href: "mailto:isnadbinomar@gmail.com",
  },
  { icon: MapPin, label: "Location", value: "Budapest, Hungary" },
...
const SOCIALS = [
  {
    label: "Instagram",
    href: "https://www.instagram.com/isnad.foto/",
    Icon: InstagramIcon,
  },
  {
    label: "LinkedIn",
    href: "https://www.linkedin.com/in/isnadomar/",
    Icon: LinkedInIcon,
  },
  {
    label: "Behance",
    href: "https://www.behance.net/isnadomar",
    Icon: BehanceIcon,
  },
];
